...
import { Accordion,AccordionItem,AccordionContent,AccordionTrigger,UnstyledAccordionTrigger } from "@/components/ui/accordion";
...
export default function FaqSection({ faqSection }) {
  ...
  return (
    !!data.faqs?.length && (
      <div className="max-w-7xl mx-auto px-4 w-full flex flex-col gap-8 py-10">
