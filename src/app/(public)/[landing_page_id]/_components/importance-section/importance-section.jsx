...
export default function ImportanceSection({ importanceSection }) {
  const sliderRef = useRef(null);
  const sectionRef = useRef(null);
  const importanceData = importanceSection;
  ...
  return (
    <section className="w-full max-w-7xl mx-auto space-y-9 md:space-y-12 px-4 py-10" ref={sectionRef}>
      <div className="flex items-center gap-2">
        <div className="p-2 bg-landing-primary text-base md:text-2xl rounded-full">
          <FaStar className="text-landing-background" />
        </div>
        <h3 className="font-bold text-3xl md:text-4xl text-landing-primary">
          <span>Importance</span>
        </h3>

        <SwiperPrevNavigationButton
          className="ml-auto border-2 bg-transparent hover:bg-landing-tertiary"
          ref={sliderRef}
        />

        <SwiperNextNavigationButton
          className="border-2 bg-transparent hover:bg-landing-tertiary"
          ref={sliderRef}
        />
      </div>
