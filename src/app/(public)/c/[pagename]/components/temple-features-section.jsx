...
export default function TempleFeaturesSection({ data }) {
  ...
  return (
    <div className="space-y-4 max-w-7xl w-full mx-auto px-4" ref={sectionRef}>
            ...
            >
              <div className="aspect-w-4 aspect-h-5 z-0 w-full relative">
                ...
                <div className="h-full w-full flex flex-col">
                  <div className="p-4 w-full bg-gradient-to-t from-black via-black/70 to-transparent text-white mt-auto z-[1] relative">
