                    ...
                    <div className='w-full relative'>
                        <label className="relative">
                            ...
                            <DatePicker
                                ...
                                className={cn("w-full rounded-lg bg-landing-background border-b-2 !h-10 duration-150 text-sm", error ? "border-red-600/80" : (focus ? "border-landing-primary" : "border-transparent"))}
