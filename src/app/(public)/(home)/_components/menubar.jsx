...
const MenubarContent = React.forwardRef(({ className, align = "center", alignOffset = 0, sideOffset = 8, handleMouseEnter, handleMouseLeave, ...props }, ref) => (
    <MenubarPrimitive.Portal>
        <MenubarPrimitive.Content
            ...
            onMouseLeave={handleMouseLeave}
            className={cn(
                "z-50 min-w-[12rem] overflow-hidden shadow-md border border-primary/20 p-2 rounded-xl",
...
const MenubarItem = React.forwardRef(({ className, inset, isActive, ...props }, ref) => (
    <MenubarPrimitive.Item
        ref={ref}
        className={cn(
            "relative flex select-none items-center rounded-[7PX] w-full py-1.5 px-4 text-sm outline-none",
